        ...
        <div className="flex">
          ...
          <div className="mx-4 flex w-9/12 flex-col justify-between py-2">
            ...
            <div className="mt-1 w-fit rounded-lg bg-hijau2">
              <p className="px-2 py-1 text-xs text-hijau">Completed</p>
            </div>
          </div>
        </div>
        <div className="mt-4 border-t-[1px] border-abu pt-4">
          <div className="flex rounded-lg bg-hijau2 p-2 text-hijau">
            <HiCheckCircle size={20} className="mr-1" />
            <p className="my-auto text-xs">Yeay, you completed it!</p>
          </div>
        </div>
      </div>
    </>
