      ...
      <section className="container m-auto w-96 mt-28 rounded-md p-6">
        ...
        <form>
          <div className="relative flex items-center mb-5">
            ...
            <input className="bg-[#f7f7f7] py-3 px-12 w-full rounded-xl text-sm focus:bg-[#dfffea] focus:ring-1 focus:ring-hijau focus:outline-none" type="text" name="" id="name" placeholder="Name"/>
          </div>
          <Password/>
          <Link href="/login">
